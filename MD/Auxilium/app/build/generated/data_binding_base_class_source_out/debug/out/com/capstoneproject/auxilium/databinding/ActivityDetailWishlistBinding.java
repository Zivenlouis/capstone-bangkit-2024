...
public final class ActivityDetailWishlistBinding implements ViewBinding {
  @NonNull
  private final NestedScrollView rootView;

  @NonNull
  public final MaterialButton btnDeleteWishlist;
  ...
  private ActivityDetailWishlistBinding(@NonNull NestedScrollView rootView,
      @NonNull MaterialButton btnDeleteWishlist, @NonNull MaterialCardView cvDetailPhone,
      @NonNull ImageView ivPhoneImages, @NonNull NestedScrollView scrollTableSpecs,
      ...
      @NonNull TextView tvRamLabel, @NonNull TextView tvReleasedDate,
      @NonNull TextView tvReleasedDateLabel, @NonNull TextView tvResolution,
      @NonNull TextView tvResolutionLabel, @NonNull TextView tvResultTitle2,
      @NonNull TextView tvSelfieCamera, @NonNull TextView tvSelfieCameraLabel,
      @NonNull TextView tvWeight, @NonNull TextView tvWeightLabel) {
    this.rootView = rootView;
    this.btnDeleteWishlist = btnDeleteWishlist;
  ...
  @NonNull
  public static ActivityDetailWishlistBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDetailWishlistBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_detail_wishlist, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDetailWishlistBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.btn_delete_wishlist;
      MaterialButton btnDeleteWishlist = ViewBindings.findChildViewById(rootView, id);
      if (btnDeleteWishlist == null) {
        break missingId;
      }
      ...
      return new ActivityDetailWishlistBinding((NestedScrollView) rootView, btnDeleteWishlist,
          cvDetailPhone, ivPhoneImages, scrollTableSpecs, tableSpesifications, tvBattery,
          tvBatteryLabel, tvBrand, tvBrandLabel, tvCharging, tvChargingLabel, tvChipset,
          tvChipsetLabel, tvColors, tvColorsLabel, tvEarphoneJack, tvEarphoneJackLabel,
          tvMainCamera1, tvMainCamera1Label, tvMainCamera2, tvMainCamera2Label, tvMainCamera3,
          tvMainCamera3Label, tvMemory, tvMemoryLabel, tvNfc, tvNfcLabel, tvPhoneNames, tvPhoneOs,
          tvPrice, tvPriceLabel, tvRam, tvRamLabel, tvReleasedDate, tvReleasedDateLabel,
          tvResolution, tvResolutionLabel, tvResultTitle2, tvSelfieCamera, tvSelfieCameraLabel,
