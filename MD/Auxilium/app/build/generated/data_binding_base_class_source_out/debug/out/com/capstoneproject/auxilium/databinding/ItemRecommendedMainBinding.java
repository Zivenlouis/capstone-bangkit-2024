...
public final class ItemRecommendedMainBinding implements ViewBinding {
  @NonNull
  ...
  private ItemRecommendedMainBinding(@NonNull MaterialCardView rootView,
  ...
  @NonNull
  public static ItemRecommendedMainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemRecommendedMainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_recommended_main, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemRecommendedMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRecommendedMainBinding((MaterialCardView) rootView, ivPhoneImages,
