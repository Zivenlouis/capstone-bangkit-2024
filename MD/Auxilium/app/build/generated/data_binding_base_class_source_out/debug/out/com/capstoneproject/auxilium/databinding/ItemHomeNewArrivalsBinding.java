...
public final class ItemHomeNewArrivalsBinding implements ViewBinding {
  @NonNull
  ...
  private ItemHomeNewArrivalsBinding(@NonNull MaterialCardView rootView,
  ...
  @NonNull
  public static ItemHomeNewArrivalsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemHomeNewArrivalsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_home_new_arrivals, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemHomeNewArrivalsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemHomeNewArrivalsBinding((MaterialCardView) rootView, ivPhoneImages,
