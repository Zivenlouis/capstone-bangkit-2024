...
public final class ActivityDetailResultBinding implements ViewBinding {
  ...
  private ActivityDetailResultBinding(@NonNull NestedScrollView rootView,
  ...
  public static ActivityDetailResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDetailResultBinding((NestedScrollView) rootView, btnAddWishlist, btnStar1,
          btnStar2, btnStar3, btnStar4, btnStar5, cvDetailPhone, ivPhoneImages, scrollTableSpecs,
          tableSpesifications, tvBattery, tvBatteryLabel, tvBrand, tvBrandLabel, tvCharging,
          tvChargingLabel, tvChipset, tvChipsetLabel, tvColors, tvColorsLabel, tvEarphoneJack,
          tvEarphoneJackLabel, tvMainCamera1, tvMainCamera1Label, tvMainCamera2, tvMainCamera2Label,
          tvMainCamera3, tvMainCamera3Label, tvMemory, tvMemoryLabel, tvNfc, tvNfcLabel,
          tvPhoneNames, tvPhoneOs, tvPrice, tvPriceLabel, tvRam, tvRamLabel, tvRatePhones,
          tvReleasedDate, tvReleasedDateLabel, tvResolution, tvResolutionLabel, tvResultTitle2,
          tvSelfieCamera, tvSelfieCameraLabel, tvWeight, tvWeightLabel);
    }
